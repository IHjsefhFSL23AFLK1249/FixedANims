...
for i,v in pairs(victim:GetChildren()) do
	...
	--[[local victim = Instance.new("Model", game.Players.LocalPlayer.Character)
	victim.Name = "Victim"
	local h = game.Players.LocalPlayer.Character.Head:Clone()
	h.Parent = victim
	h.Name = "Head"
	local t = game.Players.LocalPlayer.Character.Torso:Clone()
	t.Parent = victim
	t.Name = "Torso"
	local ll = game.Players.LocalPlayer.Character:FindFirstChild("Left Leg"):Clone()
	ll.Parent = victim
	ll.Name = "Left Leg"
	local rl = game.Players.LocalPlayer.Character:FindFirstChild("Right Leg"):Clone()
	rl.Parent = victim
	rl.Name = "Right Leg"
	local la = game.Players.LocalPlayer.Character:FindFirstChild("Left Arm"):Clone()
	la.Parent = victim
	la.Name = "Left Arm"
	local ra = game.Players.LocalPlayer.Character:FindFirstChild("Right Arm"):Clone()
	ra.Parent = victim
    ra.Name = "Right Arm"
	local huma = game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart"):Clone()
	huma.Parent = victim
	huma.Name = "HumanoidRootPart"
	local hum2222222 = game.Players.LocalPlayer.Character:FindFirstChild("Humanoid"):Clone()
	hum2222222.Parent = victim
	hum2222222.Name = "Humanoid"]]
	local fucku = {
		Head = victim:FindFirstChild("Head"),
		Torso = victim:FindFirstChild("Torso"),
		["Left Leg"] = victim:FindFirstChild("Left Leg"),
		["Right Leg"] = victim:FindFirstChild("Right Leg"),
		["Left Arm"] = victim:FindFirstChild("Left Arm"),
		["Right Arm"] = victim:FindFirstChild("Right Arm"),
		["HumanoidRootPart"] = victim:FindFirstChild("HumanoidRootPart")
	}
    local FakeCharacter2 = {
        Head = NewPart(Vector3.new(1, 1, 1), "Head"),
        Torso = NewPart(Vector3.new(2, 2, 1), "Torso"),
        ["Right Arm"] = NewPart(Vector3.new(1, 2, 1), "Right Arm"),
        ["Left Arm"] = NewPart(Vector3.new(1, 2, 1), "Left Arm"),
...
local a = game['Run Service'].Heartbeat:Connect(function()
	Victim.HumanoidRootPart.CFrame = game.Players.LocalPlayer.Character:WaitForChild("Position",60).NewTorsoPos.CFrame
	Sine=Sine+Change
